...
<head>
  ...
  <link rel="stylesheet" href="./CSS/animaIndex.css">

  <!--IMAGEM ABA-->
  <link rel="icon" href="./IMGs/LOGOS/ICONE_MS_ABA_32.png" type="image/png">

  <title>Bem-vindo ao Moraes Salgados</title>
...
<div class="criterion">
  ...
  <div class="text text5">I</div>
  <div class="text text6">N</div>
  <div class="text text7">D</div>
  <div class="text text8">O</div>

  <!--Bolinhass que caem em cima das letras-->
...
<script src="./JS/animaIndex.js"></script>
</body>
</html>
